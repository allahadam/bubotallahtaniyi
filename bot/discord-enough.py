...
TOKEN = "MTA3MDEwMDQ1NTQzMjE0Njk2Ng.GMJ7f7.c8qAgjlvUb0XYHAOPJnEEtoankv456n4E79qHY"
...
async def on_ready():
    ...
    activity = discord.Activity(type=discord.ActivityType.playing, name="Kaira#1757 ALLAHTIR AKSİNİ İDDA EDEN GELSİN")
